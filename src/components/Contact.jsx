...
const Contact = () => {
  return (
    <footer
      id="contact"
      className="bg-main-brand text-white py-8 transition-colors duration-300 dark:bg-dark-shades dark:text-gray-300"
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-center items-center space-x-4 md:space-x-8 mb-4">
          <a
            ...
            className="text-2xl md:text-3xl hover:text-highlight dark:hover:text-gray-400 transition-colors duration-300 mb-2 md:mb-0"
          >
            <FaGithub />
          </a>
          <a
        ...
        <p className="text-center text-xs md:text-sm dark:text-gray-400">
